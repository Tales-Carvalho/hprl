...
class KarelStateGenerator(object):
    ...
    def generate_program_instruct_state(self, h=8, w=8, wall_prob=0.1, env_task_metadata={}, idx=0):
        ...
        for i in range(idx):
            ...
            assert not s[agent_pos[0], agent_pos[1], 4]
...
def main():
    ...
    parser.add_argument('--dir_name', type=str, default='karel_dataset_option_L20_1m')
    ...
    args.dir_name = os.path.join('datasets_options_L20_1m/', args.dir_name)
    check_path('datasets_options_L20_1m')
