...
class NNBase(nn.Module):
    def __init__(self, recurrent, recurrent_input_size, hidden_size, dropout, rnn_type='GRU'):
        ...
        if recurrent:
            if rnn_type == 'GRU':
                self.gru = nn.GRU(recurrent_input_size, hidden_size, dropout=dropout)
            elif rnn_type == 'LSTM':
                self.lstm = nn.LSTM(recurrent_input_size, hidden_size, dropout=dropout)
